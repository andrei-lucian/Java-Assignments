...
public class Main {
    public static void main(String[] args) {
        ...
        NPC enemy_1 = new DementiaDude("A short ginger dude that looks a little crazy", 40, 100, entry);
        NPC npc_2 = new NPC("A blonde girl wearing Nike air force sneakers and drinking Starbucks coffee", 76, 24, entry);
        NPC npc_3 = new NPC("A man wearing a black and yellow shirt", 100, 200, entry);
