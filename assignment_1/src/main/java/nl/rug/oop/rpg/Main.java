...
public class Main {
    ...
    private static void initiateWorld(Player player){
        ...
        Door entry_0 = new LockedDoor("A locked door.");
        ...
        NPC enemy_1 = new Coward("A short ginger dude that looks a little crazy.", 40, 200, entry);
        NPC npc_2 = new Healer("A blonde girl wearing Nike air force sneakers and drinking Starbucks coffee.", 76, 24, room_2);
