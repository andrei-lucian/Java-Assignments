...
public class Game extends Observable implements Observer {
    ...
    public void gameLoop(Player player, Computer computer, Deck faceUp, Deck faceDown){
        while(!exitGame){
            if (playerHand.getPickedCard()!=null) {
                playerTurn(playerHand.getPickedCard(), player, currentCard, faceDown, faceUp);
                playerHand.update(player.getCardList());
                playerHand.resetPickedCard();
    ...
    public void startGame(){
        ...
        playerHand = new PlayerHand(player.getCardList());
        ...
        System.out.println(playerHand.getPickedCard());
